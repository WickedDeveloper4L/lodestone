...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head>
        <meta name="title" content="Affinity Hospitals Limited" />
        <meta
          name="description"
          content="Welcome to Affinity Hospitals Limited - where compassionate care meets cutting-edge medicine. Our dedicated team of professionals provides personalized treatment in a welcoming and modern facility. Your health and well-being are our priority, ensuring a comforting and healing experience throughout your journey to recovery. Affinity Hospitals Limited for exceptional healthcare and support."
        />
